...
"Le prénom est une porte d'entrée dans un personnage. On pénètre dans l'intime."
...
Veillez à ne pas s'approcher trop rapidement, à ne pas brusquer l'autre.  
Être vigilant aux signaux STOP (de la main) et DOUCEMENT (doigt levé).  
Recherche du consentement. QUe peut-on faire ? Qu'est-ce qui est OK pour l'autre ? Peut-il y avoir un contact physique ? Lequel ?  
...
- On doit s'efforcer de garder les gestes, sans les lâcher.  
...
## Exercice "Lâcher son texte"
En duo.  
Un objet symbolise le texte des personnages (un livre par exemple).  
...
En duo. C'est l'inverse de l'exercice précédent.  
Un objet symbolise le texte des personnages (un livre par exemple).  
...
Le focus de la scène est sur le duo A.  
Les comédien.ne.s du duo B vont se concentrer sur les fins de phrase du duo A.  
Et enchainer leur scène en commençant leur phase par la fin de la phrase du duo A.  


## Échauffement "La boîte de nuit"
Toutes et tous au plateau, ambiance boîte de nuit, lumière et musique.  
On déambule, on danse en s'échauffant les articulations, le corps, etc.  
On se laisse impacter par les 4 dimensions de la musique.  
- Rythme
- Hauteur (aigu/grave)
- Masse (nombre de sons simultanés)
- Intensité (fort/faible, variation du volume)

NB: Ces quatre dimensions sont transposables en impro. On peut varier notre jeu en fonction de ces dimensions. Par exemple, on peut jouer une scène en rythme rapide/lent, en hauteur aiguë/grave, en masse faible/forte (nombre de propositions, débit de parole), en intensité forte/faible (gravité ? dramaturgie ?).  

Puis commencer à se poser la question de la musique.  
En commençant par : Est-ce que je l'aime ? Ou pas ?  
La mélodie m'envoie quelle émotion ?  
Est-ce que ça me rappelle quelque chose ? Une situation ? Quelle émotion en découle ? Se concentrer sur cette émotion.  
...
- Qu'est-ce que notre prénom nous évoque ?  
- Qui nous l'a donné ? Mère ? Père ? Consensus des deux ? Autre ?  
- Est-ce qu'on l'aime ?  
- Qu'en fait-on dans notre vie ?  


## Le choix du prénom en impro n'est pas anodin
Le prénom qui m'est donné par mon/ma partenaire de jeu est cadeau qu'il/elle me fait.  
Ce n'est pas censé être anodin.  
Trop souvent on se donne des prénoms bâteau, toujours les mêmes, sans réfléchir.  
"Michel", "Martine", "Josiane", etc.  
...
## L.O.L.I.T.A - Le langage des oiseaux
